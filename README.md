...
| `netshoot` | A Helm chart for installing netshoot, a network troubleshooting toolbox, in Kubernetes | `0.1.0` | ❌ (`charthouse.io/release: "false"`) | [README](charts/netshoot/README.md) |
